...
public @interface ResourceResolverFactoryConfig {
    ...
    String LEGACY_REQUIRED_PROVIDER_PID =
    ...
    int resource_resolver_default_vanity_redirect_status() default
    ...
    @AttributeDefinition(
            name = "Vanity Path Cache Init In Background",
            description =
    ...
    @AttributeDefinition(
            ...
            description =
                    "Limit the maximum number of cached vanity path entries only at startup. " + "Default is true")
    ...
    @AttributeDefinition(
            ...
            description = "This flag controls whether to optimize"
                    + " the alias resolution by creating an internal cache of aliases.")
